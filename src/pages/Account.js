...
class Account extends Component{
    ...
    handleFirstChange = (event) => {
      ...
      handleSubmit=(event)=>{
        ...
        axios.post('http://localhost:8080/postPersonal',data)
    }
    render(){
            ...
            <div id="account">
                ...
                <div id="Acbox">
                    ...
                    <form id="details" onSubmit={this.handleSubmit}>
                        <div id="left">
                            <TextField className="inp" type="number" onChange={this.handleFirstChange} value={this.state.id} label="ID" required></TextField>
